...
import MultiFileExample from '../../src/components/MultiFileExample'
...
You can use [Custom Modules](../examples/custom-modules) to make use of multiple files:

<MultiFileExample />

You can find the source code for this example [here](https://github.com/elilambnz/react-py/blob/main/website/src/components/MultiFileExample.tsx).
